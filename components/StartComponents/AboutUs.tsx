...
import UsersTeamMov from '../UsersTeam';
   ...
   return (
      <TabPanel value={value} index={0} dir={theme.direction}>
         <div className='flex flex-col'>
            <div className='flex lg:flex-row flex-col border border-slate-600 border-opacity-40 rounded-md shadow-lg p-5 w-full bg-gray-100'>
